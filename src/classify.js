...
const witnessCommitment = __importStar(require("./templates/witnesscommitment"));
const witnessPubKeyHash = __importStar(require("./templates/witnesspubkeyhash"));
const witnessScriptHash = __importStar(require("./templates/witnessscripthash"));
const types = {
    P2MS: 'multisig',
