...
function valueBlindingFactor(inValues, outValues, inGenerators, outGenerators, inFactors, outFactors) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function rangeProofWithNonceHash(value, blindingPubkey, ephemeralPrivkey, asset, assetBlindingFactor, valueBlindFactor, valueCommit, scriptPubkey, minValue, exp, minBits) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function rangeProof(value, nonce, asset, assetBlindingFactor, valueBlindFactor, valueCommit, scriptPubkey, minValue, exp, minBits) {
    return __awaiter(this, void 0, void 0, function* () {
...
function surjectionProof(outputAsset, outputAssetBlindingFactor, inputAssets, inputAssetBlindingFactors, seed) {
    return __awaiter(this, void 0, void 0, function* () {
